    ...
    public void queueEvent(FacesEvent event) {
        ...
        if(isSelfRequest(context)) {
            ...
            if(eventName.equals("dateSelect")) {
				...
				int hourDelta = Integer.valueOf(params.get(clientId + "_hourDelta"));
				
				Calendar checkCalendar = Calendar.getInstance();
				checkCalendar.setTime(movedEvent.getStartDate());
				checkCalendar.setTimeZone(tz);
				checkCalendar.add(Calendar.HOUR, hourDelta);
				
				Calendar calendar = Calendar.getInstance();
				calendar.setTime(movedEvent.getStartDate());
				calendar.setTimeZone(tz);
				
				int difference = checkCalendar.get(Calendar.DAY_OF_YEAR) - calendar.get(Calendar.DAY_OF_YEAR);
				dayDelta += difference;
